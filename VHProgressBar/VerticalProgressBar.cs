...
namespace VHProgressBar
{
    ...
    public class VerticalProgressBar : UIView
    {
        UIView progressView;
        ...
        public VerticalProgressBar(NSCoder coder) : base(coder)
        {
            InitProgressView();
        }
        ...
        private void ConfigureProgressView()
        {
            ...
            progressView.Frame = new CGRect(progressView.Frame.Location.X, Bounds.Location.Y + PGHeight, PGWidth, 0);
        ...
        public void AnimateProgress(nfloat duration, nfloat progressValue)
        {
            ...
            new CGRect(progressView.Frame.Location, new CGSize(progressView.Frame.Size.Width, progressView.Frame.Size.Height - PGHeight * progressValue)));
